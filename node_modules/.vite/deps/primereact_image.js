...
var Image = React14.memo(React14.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React14.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), maskVisibleState = _React$useState2[0], setMaskVisibleState = _React$useState2[1];
  var _React$useState3 = React14.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), previewVisibleState = _React$useState4[0], setPreviewVisibleState = _React$useState4[1];
  var _React$useState5 = React14.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), rotateState = _React$useState6[0], setRotateState = _React$useState6[1];
  var _React$useState7 = React14.useState(1), _React$useState8 = _slicedToArray(_React$useState7, 2), scaleState = _React$useState8[0], setScaleState = _React$useState8[1];
  ...
  var previewButton = React14.useRef(null);
  ...
  var onMaskKeydown = function onMaskKeydown2(event) {
    switch (event.code) {
      case "Escape":
        hide();
        setTimeout(function() {
  ...
  var rotateRight = function rotateRight2(event) {
    event.stopPropagation();
    setRotateState(function(prevRotate) {
      return prevRotate + 90;
    });
  };
  var rotateLeft = function rotateLeft2(event) {
    event.stopPropagation();
    setRotateState(function(prevRotate) {
      return prevRotate - 90;
    });
  };
  var zoomIn = function zoomIn2(event) {
    event.stopPropagation();
  ...
  var zoomOut = function zoomOut2(event) {
    event.stopPropagation();
    setScaleState(function(prevScale) {
      if (zoomOutDisabled) {
        return prevScale;
  ...
  var createPreview = function createPreview2() {
    var ariaLabel = localeOption("aria") ? localeOption("aria").zoomImage : void 0;
    ...
    if (props.preview) {
      return React14.createElement("button", buttonProps, content);
    }
    return null;
  };
  var createElement9 = function createElement10() {
    ...
    var rotateRightButtonProps = mergeProps({
      ...
      onClick: rotateRight,
      type: "button",
      "aria-label": localeOption("aria") ? localeOption("aria").rotateRight : void 0,
    ...
    var rotateLeftButtonProps = mergeProps({
      ...
      onClick: rotateLeft,
      type: "button",
      "aria-label": localeOption("aria") ? localeOption("aria").rotateLeft : void 0,
      "data-pc-group-section": "action"
    ...
    var zoomOutButtonProps = mergeProps({
      ...
      "aria-label": localeOption("aria") ? localeOption("aria").zoomOut : void 0,
      "data-pc-group-section": "action"
    }, ptm("zoomOutButton"));
    var zoomInButtonProps = mergeProps({
      ...
      "aria-label": localeOption("aria") ? localeOption("aria").zoomIn : void 0,
      "data-pc-group-section": "action"
    }, ptm("zoomInButton"));
